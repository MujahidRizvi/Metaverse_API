    ...
    it('should show Asset by Type', () => {
      cy.request({
        ...
        (response) => {
          ...
          expect(response.body.data[0]).contain.keys("assetLocation","price","lat","lon", "assetName","seasonName", "assetType", "assetStatus", "imageName", "animationName", "isActive", "createdBy", "updatedBy", "description", "stickerName","createdAt", "updatedAt" )
